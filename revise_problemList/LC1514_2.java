...
public class LC1514_2 {
    ...
    public double maxProbability(int n, int[][] edges, double[] succProb, int start_node, int end_node) {
        ...
        dist[start_node] = 1;
        RevIndexMaxHeap maxHeap = new RevIndexMaxHeap(n);
        maxHeap.offerOrUpdate(new double[]{start_node, 1});
        while (!maxHeap.isEmpty()) {
            ...
            for(double[] nxtE : g[cur]){
                ...
                if(dist[cur] * prob > dist[nxt]){
                    ...
                    maxHeap.offerOrUpdate(new double[]{nxt, dist[nxt]});
                }
            }
        }
