 ...
 */
public class SegmentTreeLazyResetAndAddQueryMaxTest {
    public static void main(String[] args) throws Exception {
        ...
        SegmentTreeLazyResetAndAddQueryMax segTree = new SegmentTreeLazyResetAndAddQueryMax(n);
        ...
        for(int i = 0;i < q;i++){
            ...
            if(op == 1){
                ...
                segTree.rangeReset(1, 1, n, l, r, x);
            }else if(op == 2){
                in.nextToken(); long x = (long)in.nval;
                segTree.add(1, 1, n, l, r, x);
            }else{
                out.println(segTree.query(1, 1, n, l, r));
            }
        }
 ...
 * 这题也要开long, 否则会爆int
 */
class SegmentTreeLazyResetAndAddQueryMax {
    private long[] max;
    private long[] todoAdd;
    private long[] todoReset;
    ...
    SegmentTreeLazyResetAndAddQueryMax(int n) {
        ...
        this.todoAdd = new long[len];
        this.todoReset = new long[len];
     ...
     */
    private void doAdd(int o, int l, int r, long add){
        max[o] += add;
        todoAdd[o] += add;
    }
     ...
     */
    private void doRangeReset(int o, int l, int r, long resetVal){
